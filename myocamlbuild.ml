(* OASIS_START *)
(* DO NOT EDIT (digest: 6f5a57960ee9f050694279bad057d51a) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("yices2", ["src"], [])];
     lib_c =
       [
          ("yices2",
            "src",
     ...
     flags =
       [
          (["oasis_library_yices2_ccopt"; "compile"],
            [
          ...
          (["oasis_library_yices2_cclib"; "link"],
            [
               (OASISExpr.EBool true,
                 S
                   [
          ...
          (["oasis_library_yices2_cclib"; "ocamlmklib"; "c"],
            [(OASISExpr.EBool true, S [A "-lyices"; A "-lgmp"; A "-L../ext"])
            ]);
          (["oasis_library_yices2_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-custom"])]);
          (["oasis_library_yices2_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-custom"])]);
          (["oasis_library_yices2_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-custom"])])
       ];
     includes = [("tests", ["src"])]
  }
