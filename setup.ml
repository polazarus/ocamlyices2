...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7179a542ec73b7d5ca0cd8bd66c8b7cf) *)
(*
...
let setup_t =
  {
       ...
       [
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$(test_byte)", []))];
          ...
          ("native",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$(test_native)", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = ["MickaÃ«l Delahaye <mickael.delahaye@gmail.com>"];
          authors = ["MickaÃ«l Delahaye <mickael.delahaye@gmail.com>"];
          homepage = None;
          bugreports = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Yices is a Satisfiability Modulo Theories (SMT) solver from SRI. It is available freely for non-commercial purposes. \"OCamlYices2 is free (BSD-like) but Yices is not! **Yices is free [only] for non-commercial use** License terms: http://yices.csl.sri.com/yices-newnewlicense.html\" {success}"
              ];
          tags = [];
          categories = [];
          files_ab = [];
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "test_native"
                        ]
                   });
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/polazarus/ocamlyices2.git";
                      src_repo_browser =
                        Some "https://github.com/polazarus/ocamlyices2";
          ...
          build_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("make", ["-C"; "ext"])))];
               post_command = [(OASISExpr.EBool true, None)]
            };
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\\'a\139.\t¼2ý²ð-ûr'è";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
