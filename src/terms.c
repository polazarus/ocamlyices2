...
CAMLprim value ocamlyices_term_true(UNUSED value unit) {
  _oy_check_init();
  return _oy_nullary(&yices_true);
}
CAMLprim value ocamlyices_term_false(UNUSED value unit) {
  _oy_check_init();
  return _oy_nullary(&yices_false);
}
...
CAMLprim value ocamlyices_term_constant(value vtyp, value vval) {
  ...
  if (sizeof(intnat) > sizeof(int32_t) && val > INT32_MAX) {
    _oy_invalid_argument("index too large");
  }
...
CAMLprim value ocamlyices_term_tuple_update(value v_tuple, value v_index,
  ...
  if (index < 0) {
    _oy_invalid_argument("negative index");
  }
...
CAMLprim value ocamlyices_term_update (value v_fun, value v_args,
  ...
  args = _oy_terms_from_values(v_args, largs);
  if (args == NULL) {
    _oy_allocation_error();
  }
...
CAMLprim value ocamlyices_term_distinct (value args) {
  return _oy_nary(&yices_distinct, args);
}

CAMLprim value ocamlyices_term_forall (value arg, value body) {
  return _oy_unary_quantifier(&yices_forall, arg, body);
}

CAMLprim value ocamlyices_term_exists (value arg, value body) {
  return _oy_unary_quantifier(&yices_exists, arg, body);
}
...
CAMLprim value ocamlyices_term_foralln (value args, value body) {
  return _oy_nary_quantifier(&yices_forall, args, body);
}

CAMLprim value ocamlyices_term_existsn (value args, value body) {
  return _oy_nary_quantifier(&yices_exists, args, body);
}
...
CAMLprim value ocamlyices_term_rational_int (value v_den, value v_num) {
  ...
  if (num < 0) {
    _oy_invalid_argument("negative numerator");
  }
  if (sizeof(intnat) == sizeof(int32_t)) {
...
CAMLprim value ocamlyices_term_div(value a, value b) {
  return _oy_binary(&yices_division, a, b);
}
...
CAMLprim value ocamlyices_term_poly_int (value v_as, value v_ts) {
  ...
  if (las != lts) {
    _oy_invalid_array_sizes();
  }

  as = _oy_nativeints_from_int_values(v_as, las);
...
CAMLprim value ocamlyices_term_poly_nativeint (value v_as, value v_ts) {
  ...
  as = _oy_nativeints_from_nativeint_values(v_as, las);
  ts = _oy_terms_from_values(v_ts, lts);
  if (as == NULL || ts == NULL) {
    free(as);
    free(ts);
...
CAMLprim value ocamlyices_term_poly_int32 (value v_as, value v_ts) {
  ...
  as = _oy_int32s_from_int32_values(v_as, las);
  ts = _oy_terms_from_values(v_ts, lts);
  if (as == NULL || ts == NULL) {
    free(as);
    free(ts);
...
CAMLprim value ocamlyices_term_poly_int64 (value v_as, value v_ts) {
  ...
  as = _oy_int64s_from_int64_values(v_as, las);
  ts = _oy_terms_from_values(v_ts, lts);
  if (as == NULL || ts == NULL) {
    free(as);
    free(ts);
...
CAMLprim value ocamlyices_term_poly_rational_int (value v_nums, value v_dens,
  ...
  nums = _oy_nativeints_from_int_values(v_nums, lnums);
  dens = _oy_nativeints_from_int_values(v_dens, ldens);
  ts = _oy_terms_from_values(v_ts, lts);
  ...
  for (i = 0; i < ldens; i++) {
    if (dens[i] <= 0) {
      ...
      free(dens);
      free(ts);
      _oy_invalid_argument("null or negative denominator");
    }
  }
...
CAMLprim value ocamlyices_term_poly_rational_nativeint (value v_nums,
  ...
  ts = _oy_terms_from_values(v_ts, lts);
  nums = _oy_nativeints_from_nativeint_values(v_nums, lnums);
  dens = _oy_nativeints_from_nativeint_values(v_dens, ldens);
  if (dens == NULL || nums == NULL || ts == NULL) {
    free(nums);
    free(dens);
    free(ts);
  ...
  for (i = 0; i < ldens; i++) {
    if (dens[i] < 0) {
      ...
      free(dens);
      free(ts);
      _oy_invalid_argument("negative denominator");
    }
  }
...
CAMLprim value ocamlyices_term_poly_rational_int32 (value v_nums, value v_dens,
  ...
  nums = _oy_int32s_from_int32_values(v_nums, lnums);
  dens = _oy_int32s_from_int32_values(v_dens, ldens);
  ts = _oy_terms_from_values(v_ts, lts);
  if (dens == NULL || nums == NULL || ts == NULL) {
    free(nums);
    free(dens);
...
CAMLprim value ocamlyices_term_poly_rational_int64 (value v_nums, value v_dens,
  ...
  nums = _oy_int64s_from_int64_values(v_nums, lnums);
  dens = _oy_int64s_from_int64_values(v_dens, ldens);
  ts = _oy_terms_from_values(v_ts, lts);
...
CAMLprim value ocamlyices_term_bitvector_of_int(value vn, value vval) {
  ...
  if (n < 0) {
    _oy_invalid_argument("negative bitsize");
  }
  ...
  if (sizeof(intnat) == sizeof(uint32_t)) {
    ...
    if (n > UINT32_MAX) {
      _oy_invalid_argument("too large bitsize");
    }
...
CAMLprim value ocamlyices_term_bitvector_zero(value v_n) {
  _oy_check_init();
  return _oy_bitvector_const(&yices_bvconst_zero, v_n);
}
CAMLprim value ocamlyices_term_bitvector_one(value v_n) {
  _oy_check_init();
  return _oy_bitvector_const(&yices_bvconst_one, v_n);
}
CAMLprim value ocamlyices_term_bitvector_minus_one(value v_n) {
  _oy_check_init();
  return _oy_bitvector_const(&yices_bvconst_minus_one, v_n);
}
...
CAMLprim value ocamlyices_term_bitvector_extract(value v_t, value v_i1,
  ...
  if (i1 < 0) {
    _oy_invalid_argument("negative first index");
  }
  if (sizeof(intnat) > sizeof(uint32_t) && i1 > UINT32_MAX) {
    _oy_invalid_argument("first index too large");
  }
  if (i2 < 0) {
    _oy_invalid_argument("negative second index");
  }
  if (sizeof(intnat) > sizeof(uint32_t) && i2 > UINT32_MAX) {
    _oy_invalid_argument("second index too large");
  }
...
CAMLprim value ocamlyices_term_bitvector_concat(value arg1, value arg2) {
  return _oy_binary(&yices_bvconcat, arg1, arg2);
}
...
CAMLprim value ocamlyices_term_subst(value v_vars, value v_repls, value v_t) {
  ...
  vars = _oy_terms_from_values(v_vars, lvars);
  repls = _oy_terms_from_values(v_repls, lrepls);
...
CAMLprim value ocamlyices_term_parse (value v_str) {
  return _oy_parser(&yices_parse_term, v_str);
}
